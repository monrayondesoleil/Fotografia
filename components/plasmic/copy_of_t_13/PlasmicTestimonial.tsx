...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: _BdML9CFSoN9/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__hpKkD)}
      >
        {renderPlasmicSlot({
          defaultContents:
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___8LQzv)}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__dr2Di)}
                displayHeight={"84px"}
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__nvRCj)}
              >
                <div className={classNames(projectcss.all, sty.freeBox__wL7J5)}>
                  <h5
                    className={classNames(
                      projectcss.all,
                      projectcss.h5,
