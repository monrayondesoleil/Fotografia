...
import sty from "./PlasmicServicesWhite.module.css"; // plasmic-import: X3WZzICimdz7/css

import Icon8Icon from "./icons/PlasmicIcon__Icon8"; // plasmic-import: NoqF5XQDVNMa/icon
...
function PlasmicServicesWhite__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__suJaM)}>
        {renderPlasmicSlot({
          defaultContents: (
            <Icon8Icon
              className={classNames(projectcss.all, sty.svg__nMy7D)}
              role={"img"}
            />
          ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__qAuNn)}
      >
        <h3
