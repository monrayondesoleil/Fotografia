...
import sty from "./PlasmicCaseStudiesWraper.module.css"; // plasmic-import: YkDTpRyinUOR/css
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__kVz5Z)}
            displayHeight={"auto"}
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <Button
                className={classNames("__wab_instance", sty.button__f6XJb)}
                color={"blackCoffee"}
                submitsForm={true}
              >
                <div
