...
import sty from "./PlasmicHeader.module.css"; // plasmic-import: ccuwNEOGFfp_/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__lKyI1)}>
            <PlasmicLink__
          ...
          <div className={classNames(projectcss.all, sty.column__cqq7Y)}>
            <div
